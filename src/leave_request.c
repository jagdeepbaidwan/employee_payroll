...
char* decision_leave_request(req_id)
{
	...
	switch(k)
	{
		case 1:
		{
			...
			mysql_real_connect(connect9, "localhost", "root", "1234","payroll", 3306, NULL, 0);
			...
			if(connect9){
		        ...
		        if (mysql_query(connect9,stmt)){
					...
					mysql_real_connect(connect10, "localhost", "root", "1234","payroll", 3306, NULL, 0);
					...
					mysql_real_connect(connect2, "localhost", "root", "1234","payroll", 3306, NULL, 0);
					if(connect2){
					...
					mysql_real_connect(connect1, "localhost", "root", "1234","payroll", 3306, NULL, 0);
					if(connect1){
